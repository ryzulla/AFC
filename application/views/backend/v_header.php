...
<html>
    <head>
        ...
        <meta name="author" content="Ryan Apriyansyah" />
        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="<?php echo site_url('backend/dashboard');?>" class="logo-text"><span>AFC</span></a>
                    </div>
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        <li class="<?php echo ($menu == 'dashboard') ? 'active' : '';?>"><a href="<?php echo site_url('backend/dashboard');?>" class="waves-effect waves-button"><span class="menu-icon icon-home"></span><p>Dashboard</p></a></li>
                        <li class="droplink <?php echo (in_array($menu, ['product', 'category', 'tag'])) ? 'active open' : '';?>"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Product</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li class="<?php echo ($submenu == 'product_add') ? 'active' : '';?>"><a href="<?php echo site_url('backend/product/add_new');?>">Add New</a></li>
                                <li class="<?php echo ($submenu == 'product_list') ? 'active' : '';?>"><a href="<?php echo site_url('backend/product');?>">Product List</a></li>
                                <li class="<?php echo ($submenu == 'category') ? 'active' : '';?>"><a href="<?php echo site_url('backend/category');?>">Category</a></li>
                                <li class="<?php echo ($submenu == 'tag') ? 'active' : '';?>"><a href="<?php echo site_url('backend/tag');?>">Tag</a></li>
                            </ul>
                        </li>
                        <li class="droplink <?php echo (in_array($menu, ['post'])) ? 'active open' : '';?>"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Post</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li class="<?php echo ($submenu == 'post_add') ? 'active' : '';?>"><a href="<?php echo site_url('backend/post/add_new');?>">Add New</a></li>
                                <li class="<?php echo ($submenu == 'post_list') ? 'active' : '';?>"><a href="<?php echo site_url('backend/post');?>">Post List</a></li>
                            </ul>
                        </li>
                        <li class="<?php echo ($menu == 'inbox') ? 'active' : '';?>"><a href="<?php echo site_url('backend/inbox');?>" class="waves-effect waves-button"><span class="menu-icon icon-envelope"></span><p>Inbox</p></a></li>
                        <li class="<?php echo ($menu == 'comment') ? 'active' : '';?>"><a href="<?php echo site_url('backend/comment');?>" class="waves-effect waves-button"><span class="menu-icon icon-bubbles"></span><p>Comments</p></a></li>
                        <li class="<?php echo ($menu == 'subscriber') ? 'active' : '';?>"><a href="<?php echo site_url('backend/subscriber');?>" class="waves-effect waves-button"><span class="menu-icon icon-users"></span><p>Subscribers</p></a></li>
                        <li class="<?php echo ($menu == 'testimonial') ? 'active' : '';?>"><a href="<?php echo site_url('backend/testimonial');?>" class="waves-effect waves-button"><span class="menu-icon icon-like"></span><p>Testimonials</p></a></li>
                        <li class="<?php echo ($menu == 'ip_blocker') ? 'active' : '';?>"><a href="<?php echo site_url('backend/ip_blocker');?>" class="waves-effect waves-button"><span class="menu-icon icon-lock"></span><p>IP Blocker</p></a></li>
                        <?php if($this->session->userdata('access')=='1'):?>
                        <li class="<?php echo ($menu == 'users') ? 'active' : '';?>"><a href="<?php echo site_url('backend/users');?>" class="waves-effect waves-button"><span class="menu-icon icon-user"></span><p>Users</p></a></li>
                        <li class="droplink <?php echo (in_array($menu, ['settings', 'home_setting', 'slider', 'pengiriman', 'about_setting', 'navbar', 'change_pass'])) ? 'active open' : '';?>"><a href="<?php echo site_url('backend/settings');?>" class="waves-effect waves-button"><span class="menu-icon icon-settings"></span><p>Settings</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li class="<?php echo ($submenu == 'settings') ? 'active' : '';?>"><a href="<?php echo site_url('backend/settings');?>">Basic</a></li>
                                <li class="<?php echo ($submenu == 'home_setting') ? 'active' : '';?>"><a href="<?php echo site_url('backend/home_setting');?>">Home</a></li>
                                <li class="<?php echo ($submenu == 'slider') ? 'active' : '';?>"><a href="<?php echo site_url('backend/slider');?>">Slider</a></li>
                                <li class="<?php echo ($submenu == 'pengiriman') ? 'active' : '';?>"><a href="<?php echo site_url('backend/pengiriman');?>">Pengiriman</a></li>
                                <li class="<?php echo ($submenu == 'about_setting') ? 'active' : '';?>"><a href="<?php echo site_url('backend/about_setting');?>">About</a></li>
                                <li class="<?php echo ($submenu == 'navbar') ? 'active' : '';?>"><a href="<?php echo site_url('backend/navbar');?>">Navbar</a></li>
                            </ul>
                        </li>
                        <?php endif;?>
