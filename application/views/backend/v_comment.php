                                    ...
                                    <div class="tab-content">
                                        ...
                                        <?php foreach ($data->result() as $row) :?>
                                                ...
                                                <div class="pull-right m-r-md">
                                                    <div class="btn-group">
                                                      ...
                                                      <ul class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <?php else:?>
                                                        <li><a href="javascript:void(0);" class="btn-reply" data-comment_id="<?php echo $row->comment_id;?>" data-post_id="<?php echo $row->product_id;?>"><span class="fa fa-reply"></span> Reply</a></li>
                                                        <li><a href="javascript:void(0);" class="btn-edit" data-comment_id="<?php echo $row->comment_id;?>" data-comment_msg="<?php echo $row->comment_message;?>"><span class="fa fa-edit"></span> Edit</a></li>
                                                        <li><a href="javascript:void(0);" class="btn-delete" data-comment_id="<?php echo $row->comment_id;?>"><span class="fa fa-trash"></span> Delete</a></li>
                                                        <?php endif;?>
                                                      </ul>
                                            ...
                                            <?php 
                                                ...
                                                $result = $this->db->query("SELECT comment_id,DATE_FORMAT(comment_date,'%d %M %Y %H:%i') AS comment_date,comment_name,comment_email,comment_message,comment_product_id AS product_id FROM tbl_comment_product WHERE comment_parent='$comment_id' ORDER BY comment_id ASC");
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $('.btn-reply').on('click',function(){
                    ...
                    var product_id=$(this).data('post_id');
