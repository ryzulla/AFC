                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="javascript:void(0);" class="btn btn-xs btn-edit" data-id="<?php echo $row->category_id;?>" data-category="<?php echo $row->category_name;?>" data-desc="<?php echo htmlspecialchars($row->category_description, ENT_QUOTES);?>"><span class="fa fa-pencil"></span></a>
