    ...
    <body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Product</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li class="active"><a href="<?php echo site_url('backend/product/add_new');?>">Add New</a></li>
                                <li><a href="<?php echo site_url('backend/product');?>">Product List</a></li>
                        ...
                        <li class="droplink "><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Post</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li class=""><a href="<?php echo site_url('backend/post/add_new');?>">Add New</a></li>
                        ...
                        <li class="droplink"><a href="<?php echo site_url('backend/settings');?>" class="waves-effect waves-button"><span class="menu-icon icon-settings"></span><p>Settings</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                ...
                                <li class=""><a href="<?php echo site_url('backend/pengiriman');?>">Pengiriman</a></li>
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <form action="<?php echo base_url().'backend/product/edit'?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-8">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label>Title</label>
                                            <input type="text" name="title" value="<?php echo $b['product_title'];?>" class="form-control" placeholder="Title" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="slug" class="form-control" value="<?php echo $b['product_slug'];?>" placeholder="Permalink" style="background-color: #F8F8F8;outline-color: none;border:0;color:blue;" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Contents</label>
                                            <textarea name="contents" id="summernote"><?php echo $b['product_contents'];?></textarea>
                                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        <div class="form-group">
                                            <label>Image</label>
                                            <input type="file" name="filefoto" class="dropify" data-height="190" data-default-file="<?php echo base_url().'assets/images/'.$b['product_image'];?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Price (Rp)</label>
                                            <input type="text" name="price" class="form-control Price" value="<?php echo $b['product_price'];?>" required>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="category" required>
                                                ...
                                                <?php foreach ($category->result() as $row) : ?>
                                                    <?php if($b['product_category_id']==$row->category_id):?>
                                        ...
                                        <?php 
                                            $product_tag=$b['product_tags'];
                                            $strtag=explode(",", $product_tag);
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" name="product_id" value="<?php echo $b['product_id'];?>" required>
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" cols="6" rows="6" class="form-control" placeholder="Meta Description"><?php echo $b['product_description'];?></textarea>
                                        </div>
                ...
                <div class="page-footer">
                    <p class="no-s"><?php echo date('Y');?> &copy; Powered by Ryan Apriyansyah.</p>
                </div>
            </div><!-- Page Inner -->
        </main><!-- Page Content -->
