                ...
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Product</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="<?php echo site_url('backend/product/add_new');?>">Add New</a></li>
                        ...
                        <li class="active"><a href="<?php echo site_url('backend/counter');?>" class="waves-effect waves-button"><span class="menu-icon icon-bar-chart"></span><p>Counter</p></a></li>
