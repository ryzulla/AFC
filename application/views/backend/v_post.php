                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        ...
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-delete" onclick="deletePost('<?php echo $row->post_id;?>')" data-id="<?php echo $row->post_id;?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                            </tbody>
