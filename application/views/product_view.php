				...
				<section class="page-section small-section">				
					<div class="container relative">
						...
						<div class="row multi-columns-row">
								...
								<div class="col-md-3 col-sm-6 mb-30 wow fadeIn">
									<article>
										<a class="articles-card" href="<?php echo site_url('product/'.$row->product_slug);?>" title="">
											<div class="card-wrap">
												<div class="card-image">
													<div class="article-thumbnail" data-background="<?php echo base_url().'assets/images/thumb/'.$row->product_image;?>"></div>				
												</div>
												<div class="card-body">
													<h2 class="heading6 lp-0 mt-0 font-face1 text-left"><?php echo $row->product_title;?></h2>
													<p>Rp <?=$row->product_price?></p>
												</div>
											</div>
										</a><br>
										<div class="like light-text"><a href="javascript:void(0)"></a> <?php echo $row->product_views.' views';?></div>
									</article>
								</div>
								<?php endforeach;?>
						</div>
